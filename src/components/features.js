            ...
            <div className="row">
                <div className="col-md-6 col-xs-12">
                    <div className="card feature-card blue-card">
                        <img src="img/climbing.jpg" alt="LU WALL" className="card-img-top feature-image" fluid />
                ...
                <div className="col-md-6 col-xs-12">
                    <div className="card feature-card orange-card">
                        <img src="img/climbing1.jpg" alt="CLIMBING WALL" className="card-img-top feature-image" fluid />
                        <div className="card-body">
